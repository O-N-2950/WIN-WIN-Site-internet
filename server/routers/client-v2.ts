  ...
  createFromSignature: publicProcedure
    .input(
      z.object({
        ...
        statutProfessionnel: z.enum(['Employé(e)', 'Indépendant(e)', 'Retraité(e)', 'Sans Emploi', 'Au chômage', 'Ai', 'Etudiant(e)', 'Enfant']).optional(),
        profession: z.string().optional(),
        employeur: z.string().optional(),
        tauxActivite: z.string().optional(),
        situationFamiliale: z.enum(['Célibataire', 'Marié(e)', 'Divorcé(e)', 'Veuf/Veuve', 'Concubin(e)']).optional(),
      ...
      try {
        ...
        if (typeMandat === 'prive') {
          ...
          const clientData: ClientData = {
            ...
            'Permis d\'Etablissement': input.permisEtablissement,
            ...
            Banque: input.banque || input.banquePersonnelle,
            IBAN: input.iban || input.ibanPersonnel,
            ...
            'Nom de la banque': input.banque || input.banquePersonnelle,
            Language: 'Français',
          };
