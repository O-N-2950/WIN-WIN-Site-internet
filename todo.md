...
- [ ] Ajouter option "Autre" dans listes Banque et Nationalité avec champ texte libre
- [ ] Corriger backend server/routers.ts pour accepter tous les nouveaux champs du questionnaire
