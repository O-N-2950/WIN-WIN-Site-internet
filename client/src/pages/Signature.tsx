  ...
  const saveSignature = async () => {
    ...
    try {
      ...
      const clientResult = await createClientMutation.mutateAsync({
        ...
        banque: workflow.questionnaireData.banque,
        iban: workflow.questionnaireData.iban,
        nomEntreprise: workflow.questionnaireData.nomEntreprise,
        banqueEntreprise: workflow.questionnaireData.banqueEntreprise,
        ibanEntreprise: workflow.questionnaireData.ibanEntreprise,
