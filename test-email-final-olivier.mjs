...
console.log('📧 Envoi email final à Olivier avec son vrai code de parrainage...\n');
...
const clientData = {
  ...
  codeParrainage: 'OLIV-SELS', // VRAI CODE depuis Airtable
  montantPaye: 185
};
...
resend.emails.send({
        ...
        <div class="content">
          ...
          <div class="info-box" style="background: linear-gradient(135deg, #e8f5e9 0%, #f1f8e9 100%); border-left: 4px solid #4caf50;">
            ...
            <div style="text-align: center; margin: 20px 0;">
              <a href="https://wa.me/?text=🎉%20Rejoins-moi%20chez%20WIN%20WIN%20Finance%20!%0A%0AUtilise%20mon%20code%20de%20parrainage%20%3A%20${clientData.codeParrainage}%0A%0ATu%20bénéficieras%20d'un%20rabais%20immédiat%20et%20nous%20bénéficierons%20tous%20de%20rabais%20de%20groupe%20!%0A%0APlus%20on%20est%20de%20membres%2C%20plus%20le%20rabais%20est%20élevé%20(jusqu'à%2020%25%20!)%0A%0AInfos%20%3A%20https%3A%2F%2Fwww.winwin.swiss" 
            ...
            <ol style="text-align: left; line-height: 1.8;">
              <li>Partagez votre code avec vos proches (famille, amis...)</li>
  ...
  console.log('\n🎉 EMAIL FINAL AVEC SYSTÈME DE PARRAINAGE VIRAL COMPLET !');
  console.log('✅ Domaine vérifié: winwin.swiss');
  console.log('✅ Code de parrainage réel: OLIV-SELS');
  console.log('✅ 3 boutons de partage (WhatsApp, Email, SMS)');
  console.log('✅ Tableau des rabais de groupe');
  console.log('✅ Texte adapté pour famille + amis');
}).catch((error) => {
